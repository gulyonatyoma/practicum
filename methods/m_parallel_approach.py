...
def m_parallel_approach(obj, is_catch):
    table = obj.data
    if is_catch == False:
    ...
    while d > obj.max_dist:
        ...
        (x1_par, y1_par) = obj.math_f.parallel_line(x_c, y_c, x_aim,
                                                    y_aim, x_aim + obj.v_x * obj.t, y_aim + obj.v_y * obj.t)
        (x2_par, y2_par) = (x_aim + obj.v_x *
                            obj.t, y_aim + obj.v_y * obj.t)
        a = obj.math_f.circle_and_line(
            x1_par, y1_par, x2_par, y2_par, x_c, y_c, abs(obj.v_c))
